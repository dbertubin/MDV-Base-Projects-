...
$('#home').live("pageshow",function(){
                $.couch.urlPrefix = 'https://therfeedsomarinjuslaheng:IXleSseEqqlLXeAS4P08Nihu@dbertubin.cloudant.com/iawt/_design/app/_view/listAll';
                $('#listView').empty();
...
$('#current').live("pageshow",function(){
                   $.couch.urlPrefix = 'https:/\/\towasconederembutiesells:YeX3fPEB856YjRUsVPsXm8sy@dbertubin.cloudant.com';
                   $('#currentView').empty();
