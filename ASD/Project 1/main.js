...
/* needs work this was breaking my code, set to revisit on next version  
	function getCheckBoxValue(){
		if ($("selectDue").checked){
			selectDueValue = $("selectDue").value;
		}else{
			 = "No";
		}
	}; 
...
//			item.selectDue	= ["Select a Due Date?:", selectDueValue];
